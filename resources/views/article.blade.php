                ...
                <div class="swiper-wrapper">
                        ...
                        <article>
                            <div class="card shadow-lg">
                                <figure class="card-img-top overlay overlay-1"><a href="#"> <img
                                            src="../../assets/img/photos/b12.jpg" alt="" /></a>
                                    <figcaption>
                    ...
                    <div class="swiper-slide">
                        <article>
                            <div class="card shadow-lg">
                                <figure class="card-img-top overlay overlay-1"><a href="#"> <img
                                            src="../../assets/img/photos/b13.jpg" alt="" /></a>
                                    <figcaption>
                                        <h5 class="from-top mb-0">Read More</h5>
                                    </figcaption>
                                </figure>
                    ...
                    <div class="swiper-slide">
                        <article>
                            <div class="card shadow-lg">
                                <figure class="card-img-top overlay overlay-1"><a href="#"> <img
                                            src="../../assets/img/photos/b14.jpg" alt="" /></a>
                                    <figcaption>
                                        <h5 class="from-top mb-0">Read More</h5>
                                    </figcaption>
                                </figure>
                    ...
                    <div class="swiper-slide">
                        <article>
                            <div class="card shadow-lg">
                                <figure class="card-img-top overlay overlay-1"><a href="#"> <img
                                            src="../../assets/img/photos/b15.jpg" alt="" /></a>
                                    <figcaption>
                                        <h5 class="from-top mb-0">Read More</h5>
                                    </figcaption>
                                </figure>
                                <div class="card-body p-6">
                                    ...
                                    <div class="post-footer">
                                        <ul class="post-meta d-flex mb-0">
                                            <li class="post-date"><i class="uil uil-calendar-alt"></i><span>17 Jan
                                                    2022</span></li>
                    ...
                    <div class="swiper-slide">
                        <article>
                            <div class="card shadow-lg">
                                <figure class="card-img-top overlay overlay-1"><a href="#"> <img
                                            src="../../assets/img/photos/b16.jpg" alt="" /></a>
                                    <figcaption>
                                        <h5 class="from-top mb-0">Read More</h5>
                                    </figcaption>
                                </figure>
                                <div class="card-body p-6">
                                    <div class="post-header">
                                        ...
                                        <h2 class="post-title h3 mt-1 mb-3"><a class="link-dark"
                                                href="../../blog-post.html">Nulla vitae elit libero</a></h2>
                                    </div>
                                    <div class="post-footer">
                                        <ul class="post-meta d-flex mb-0">
                    ...
                    <div class="swiper-slide">
                        <article>
                            <div class="card shadow-lg">
                                <figure class="card-img-top overlay overlay-1"><a href="#"> <img
                                            src="../../assets/img/photos/b17.jpg" alt="" /></a>
                                    <figcaption>
                                        <h5 class="from-top mb-0">Read More</h5>
                                    </figcaption>
                                </figure>
                                <div class="card-body p-6">
                                    <div class="post-header">
                                        ...
                                        <h2 class="post-title h3 mt-1 mb-3"><a class="link-dark"
                                                href="../../blog-post.html">Pharetra augue elit sem</a></h2>
                                    </div>
                                    <div class="post-footer">
                                        <ul class="post-meta d-flex mb-0">
                                            <li class="post-date"><i class="uil uil-calendar-alt"></i><span>2 Jan
                                                    2022</span></li>
                                        </ul>
                                    </div>
                                </div>
